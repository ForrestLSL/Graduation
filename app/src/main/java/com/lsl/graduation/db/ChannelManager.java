...
public class ChannelManager {
    ...
    static {
        ...
        defaultOtherChannels.add(new ChannelItem(2, "足球", 2, 1));
...
//         defaultUserChannels.add(new ChannelItem(7, "图片", 1, 0));
        ...
        defaultUserChannels.add(new ChannelItem(8, "笑话", 2, 0));
        ...
        defaultUserChannels.add(new ChannelItem(22, "彩票", 16, 1));
        defaultUserChannels.add(new ChannelItem(23, "教育", 17, 1));
        defaultUserChannels.add(new ChannelItem(24, "论坛", 18, 1));
        ...
        defaultUserChannels.add(new ChannelItem(31, "亲子", 25, 1));
    }
    private ChannelManager(SQLHelper dbHelper) throws SQLException{
        if (channelDao==null)
            channelDao=new ChannelDao(dbHelper.getContext());
        initDefaultChannel();
        return;
    }
    ...
    private void initDefaultChannel() {
        MLog.d("Graduation---ChannelManager--deleteAll","deleteAll");
        deleteAllChannel();
